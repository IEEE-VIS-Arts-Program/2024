...
<tr><td>Submissions deadline:</td><td>June 2, 2024</td>
...
papers related to the theme *Diverse Data*. Submissions can
...
Entries](https://visap.net/2024/)).

#### Paper Format

Authors are required to use the [IEEE Conference
format](https://tc.computer.org/vgtc/publications/conference/) for
paper
submissions. [Word](https://www.cspaul.com/vgtc/vgtc_conference_word.zip) and [LaTeX](https://www.cspaul.com/vgtc/vgtc_conference_latex.zip) templates
are available. It is mandatory to use this format. However, including
keywords and index terms is optional.

Paper submissions must not exceed 10 pages&mdash;including all figures and
references.
...
portfolios related to the theme *Diverse Data*. Artists,
...
submissions. <a href="https://visap.net/2024/downloads/VISAP_pictorial_Indd.zip">InDesign</a> and <a href="https://visap.net/2024/downloads/VISAP_pictorial_Word.zip">Word</a> templates
...
catalog](https://visap.net/2019/media/VISAP19-Catalogue.pdf) (designed
by Damla Çay), [2018
catalog](http://visap.net/2018/media/VISAP18-Catalogue.pdf) (designed
by Density Design), the [2017
catalog](http://visap.uic.edu/2017/materials/ExhibitionCatalog-Sustain&Decay.pdf) (designed
by Yoon Chung Han), the [2016
catalog](http://visap.uic.edu/2016/materials/VISAP2016_ExhibitionCatalog_Metamorphoses.pdf) (designed
by Jeremy Boy), the [2015
catalog](http://visap.uic.edu/2015/DataImprovisations_Catalog.pdf) (designed
by Jack Henrie Fisher), the [2014
catalog](http://visap.uic.edu/2014/art/VISAP2014_ArtShowCatalog.pdf),
or the [2013
catalog](http://visap.uic.edu/2013/VISAP_ArtShow_Catalog_2013.pdf) (both
...
The VISAP 2024 exhibition chairs will contact the exhibitors upon
acceptance.
...
2024 Papers and Exhibition submissions by:

1.  Clicking on the "Submissions" tab

2.  Selecting VTGC (in "Society"); VIS 2024 (for "Conference/Journal"),
    and VIS 2024 Arts Program (for "Track"), and
